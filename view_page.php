...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="index.php">home</a><i class="bx bx-right-arrow-alt"></i>product detail</span>
        </div>
    </div>
    ...
    <div class="products">
        <div class="heading">
            ...
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error unde dolores explicabo officiis possimus similique quod sed et veniam quidem.</p>
            <img src="image/separator-img.png">
        </div>
