...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <span><a href="index.php">home</a><i class="bx bx-right-arrow-alt"></i>search products</span>
        </div>
    </div>
    <div class="products">
        <div class="heading">
        ...
        <div class="box-container">
            <?php  
                if(isset($_POST['search_product']) or isset($_POST['search_product_btn'])){
                    ...
                    $search_products = htmlspecialchars($_POST['search_product']);
            ...
            <form action="" method="post" class="box <?php if($fetch_products['stock'] == 0){echo 'disabled';} ?>">
                ...
                ?>
                <div class="content">
                    <img src="image/shape-19.png" alt="shap" class="shap">
                    <div class="button">
