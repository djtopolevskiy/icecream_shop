<div class="newsletter">
    <div class="content">
        ...
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptate porro minima soluta<br> doloremque dolorum nesciunt unde, voluptatum debitis deserunt quisquam.</p>
        <div class="input-field">
            <input type="email" name="" placeholder="Enter yuor email">
...
<footer>
    <div class="content">
        ...
        <div class="box">
            ...
            <p><i class="bx bxs-envelope"></i>djtopolevskiy@gmail.com</p>
            <p><i class="bx bxs-location-plus"></i>Noth America, USA</p>
            <div class="icons">
    ...
    <div class="bottom">
        <p>Copyright 2023 code. All Right Reserved</p>
